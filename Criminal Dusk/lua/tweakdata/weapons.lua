  ...
  for _, class in pairs(WeaponClasses) do
    for NewDamage, weapons in pairs(class) do
      for _, WeaponName in ipairs(weapons) do
        ...
        local MostShotsToKill = 480 / (BaseMult * NewDamage * 2)
        local LeastShotsToKill = 480 / (BaseMult * NewDamage * 1.05 * 2.5)
        self[WeaponName].AMMO_PICKUP = { LeastShotsToKill - 0.75, MostShotsToKill + 0.5 }
      end
    end
  end
