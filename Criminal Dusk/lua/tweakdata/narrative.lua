Hooks:PostHook(NarrativeTweakData, "init", "CrimDusk_NarrativeTweakInit", function(self, tweak_data)
  ...
  self.jobs.cd_watchdogs1 = deep_clone(self.jobs.watchdogs_wrapper)
  self.jobs.cd_watchdogs1.name_id = "heist_watchdogs_1_hl"
  self.jobs.cd_watchdogs1.briefing_id = "heist_watchdogs_1_briefing"
  self.jobs.cd_watchdogs1.chain = { self.stages.watchdogs_1 }
  self.jobs.cd_watchdogs1.job_wrapper = nil

  self.jobs.cd_watchdogs2 = deep_clone(self.jobs.watchdogs_wrapper)
  self.jobs.cd_watchdogs2.name_id = "heist_watchdogs_2_hl"
  self.jobs.cd_watchdogs2.briefing_id = "heist_watchdogs_2_briefing"
  self.jobs.cd_watchdogs2.chain = { self.stages.watchdogs_2 }
  self.jobs.cd_watchdogs2.job_wrapper = nil
