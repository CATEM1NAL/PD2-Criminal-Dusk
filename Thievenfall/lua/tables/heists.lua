...
Global.CrimDusk.heists = {
  ...
  pines = { grading = "color_bhd", suit = "rusbear" },
  cage = { stealthable = true, bonus = "big", grading = "color_xgen", suit = "suit" },
  hox_3 = { grading = "color_xxxgen", suit = "slaughterhouse" },
  shoutout_raid = { grading = "color_heat", suit = "slaughterhouse" },
  arena = { grading = "color_bhd", suit = "leatherfluff" },
  jolly = { suit = "slaughterhouse" },
  cane = { grading = "color_bhd", suit = "elfsuit" },
  peta = { grading = "color_heat", suit = "suit" },
  peta2 = { grading = "color_xxxgen", suit = "suit" },
  dark = { unmasked = true, stealthable = true, bonus = "big", grading = "color_bhd", suit = "cable_guy" },
  mad = { grading = "color_bhd", suit = "winter_suit" },
  born = { grading = "color_xxxgen", suit = "suit" },
  chew = { grading = "color_xxxgen", suit = "slaughterhouse" },
  moon = { grading = "color_nice", suit = "lonorwa" },
  spa = { grading = "color_xxxgen", suit = "slaughterhouse" },
  fish = { unmasked = true, stealthable = true, bonus = "small", grading = "color_xxxgen", suit = "tux" },
  rvd2 = { grading = "color_xxxgen", suit = "suit" },

  -- Transport
  arm_cro = { grading = "color_xxxgen", suit = "slaughterhouse" },
  arm_hcm = { grading = "color_heat", suit = "slaughterhouse" },
  arm_par = { grading = "color_heat", suit = "slaughterhouse" },
  arm_fac = { grading = "color_xxxgen", suit = "slaughterhouse" },
  arm_und = { grading = "color_xxxgen", suit = "jumpsuit" },
  arm_for = { delay = 10, grading = "color_nice", suit = "slaughterhouse" },

  -- Dentist
  big = { suit = "suit" },
  mia_1 = { grading = "color_bhd", suit = "suit" },
  mia_2 = { grading = "color_xxxgen", suit = "slaughterhouse" },
  hox_1 = { grading = "color_bhd", suit = "slaughterhouse" },
  hox_2 = { grading = "color_nice", suit = "slaughterhouse" },
  ...
  crojob3 = { grading = "color_bhd", suit = "slaughterhouse" },
  crojob3_night = { grading = "color_xxxgen", suit = "slaughterhouse" },
  ...
  -- Post-game
  hvh = { grading = "color_matrix_classic", suit = "haunted" },
  help = { grading = "color_matrix_classic", suit = "classyske" },
  nail = { grading = "color_matrix_classic", suit = "moneysuit" },
  haunted = { grading = "color_matrix_classic", suit = "moneysuit" },
  rat = { grading = "color_xxxgen", suit = "slaughterhouse" }
}