...
Hooks:PostHook(VictoryState, "at_enter", "CrimDusk_HeistWon", function(self)
  ...
  if managers.job:on_last_stage() then
    ...
    elseif (Global.CrimDusk.data[heists_won] > #Global.CrimDusk.campaign) or CrimDusk.IsPermadeath() == "_perma" then
      ...
      local CurrentHeists = Global.CrimDusk.data["next_heists" .. CrimDusk.IsPermadeath()]
      for i = 1, #CurrentHeists do table.insert(Global.CrimDusk.data.heist_chain, (Global.CrimDusk.job_to_wrapper[CurrentHeists[i]] or CurrentHeists[i])) end
