...
Hooks:OverrideFunction(CrimeNetManager, "activate_job", function(self)
  ...
  if next(HeistsGenerated) then
    self._MAX_ACTIVE_JOBS = #HeistsGenerated < self._MAX_ACTIVE_JOBS and #HeistsGenerated or self._MAX_ACTIVE_JOBS
  ...
  local PlayableHeists = #self._presets < self._MAX_ACTIVE_JOBS and #self._presets or self._MAX_ACTIVE_JOBS

  for i = 1, PlayableHeists do
    while true do
